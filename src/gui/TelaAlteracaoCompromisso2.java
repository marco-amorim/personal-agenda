...
public class TelaAlteracaoCompromisso2 extends JFrame {
	...
	private JTextField textConfirmaAlteracao;
	...
	public TelaAlteracaoCompromisso2(Compromisso compConsulta) {
		...
		JLabel lblConfirmaIncluso = new JLabel("CONFIRMA ALTERA\u00C7\u00C3O ( S/N ) ?");
		...
		btnIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (textConfirmaAlteracao.getText().equalsIgnoreCase("s")) {
